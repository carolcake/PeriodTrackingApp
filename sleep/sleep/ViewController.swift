...
class ViewController: UIViewController
{
    ...
    @IBAction func sleepButton(_ sender: Any)
    {
        ...
        if numberOfClicks == 1
        {
            sleep1.image = UIImage(named:"stars")
        }
        if numberOfClicks == 2
        {
            sleep2.image = UIImage(named:"stars")
        }
        if numberOfClicks == 3
        {
            sleep3.image = UIImage(named:"stars")
        }
        if numberOfClicks == 4
        {
            sleep4.image = UIImage(named:"stars")
        }
        if numberOfClicks == 5
        {
            sleep5.image = UIImage(named:"stars")
        }
        if numberOfClicks == 6
        {
            sleep6.image = UIImage(named:"stars")
        }
        if numberOfClicks == 7
        {
            sleep7.image = UIImage(named:"stars")
        }
        if numberOfClicks == 8
        {
            sleep8.image = UIImage(named:"stars")
        }
        if numberOfClicks == 9
        {
            sleep9.image = UIImage(named:"stars")
        }
        if numberOfClicks == 10
        {
            sleep10.image = UIImage(named:"stars")
        }
        if numberOfClicks == 11
        {
            sleep11.image = UIImage(named:"stars")
        }
        if numberOfClicks == 12
        {
            sleep12.image = UIImage(named:"stars")
        }
